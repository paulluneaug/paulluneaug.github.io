...
This project allowed me to learn a lot about the Unity editor and its programming interface. {{< br >}}
...
{{< button href="https://github.com/paulluneaug/UnityUtility" target="_blank">}}
{{< icon "github" >}} GitHub Repository
{{< /button >}}

{{< empty-p >}}

{{< github repo="paulluneaug/UnityUtility" showThumbnail=false >}}